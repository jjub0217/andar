...
import "swiper/swiper-bundle.css"; // 추가: Swiper 스타일 시트 import
  ...
  const bestProducts = {
    best1: [
      ...
      },
      {
        ...
        discount: "30%",
        currentPrice: "65,000원",
        originalPrice: "94,000원",
